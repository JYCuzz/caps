...
public class Tp_img {
	...
	public int getTp_img_Name() {
		return tp_img_Name;
	}
	public void setTp_img_Name(int tp_img_Name) {
	...
	public Tp_img(int tp_img_ID, int tp_img_Name, int tpID, String tp_img_path) {
		super();
		this.tp_img_ID = tp_img_ID;
		this.tp_img_Name = tp_img_Name;
		this.tpID = tpID;
